...
<table>
  ...
  <tr>
    ...
    <td>- SPDY의 영향으로 이진 프로토콜, 다중화, 헤더 압축 <br> - 서버 푸시 및 TLS 사용 강화 <br> - 단점: TCP의 헤드-오브-라인 블로킹 여전히 문제</td>
  </tr>
  <tr>
    <td>HTTP/3.0</td>
